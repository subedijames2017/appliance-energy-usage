const {
  calculateEnergyUsageSimple: calculateEnergyUsageSimpleService,
  calculateEnergySavings: calculateEnergySavingsService,
  calculateEnergyUsageForDay: calculateEnergyUsageForDayService,
} = require('./services');
 ...
 * ```
 */
const calculateEnergyUsageSimple = calculateEnergyUsageSimpleService;
 ...
 */
const calculateEnergySavings = calculateEnergySavingsService;
...
const calculateEnergyUsageForDay = calculateEnergyUsageForDayService;
